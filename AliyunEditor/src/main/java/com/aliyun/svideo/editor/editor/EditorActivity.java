...
public class EditorActivity extends FragmentActivity {
    ...
    private static final String NEXT_ACTIVITY_CLASS_NAME = "com.cvnchina.xingwanban.ui.activity.PublishActivity";
    ...
    private void initData() {
        ...
        boolean canReplaceMusic = intent.getBooleanExtra(AlivcEditInputParam.INTENT_KEY_REPLACE_MUSIC, false);
