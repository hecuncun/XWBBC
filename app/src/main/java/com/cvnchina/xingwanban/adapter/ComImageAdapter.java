 ...
 * data：16/7/27
 */
public class ComImageAdapter extends
        RecyclerView.Adapter<ComImageAdapter.ViewHolder> {
    ...
    public ComImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.icon_shangchuan);
